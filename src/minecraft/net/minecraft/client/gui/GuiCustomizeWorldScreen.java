...
public class GuiCustomizeWorldScreen extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder {
    ...
    private void func_175328_i() {
        ...
        this.field_175333_f = I18n.format("book.pageIndicator", Integer.valueOf(this.field_175349_r.func_178059_e() + 1), this.field_175349_r.func_178057_f());
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.field_175339_B != 0) {
            ...
            worldrenderer.pos(this.width / 2f - 90, 185.0D, 0.0D).tex(0.0D, 2.65625D).color(64, 64, 64, 64).endVertex();
            worldrenderer.pos(this.width / 2f + 90, 185.0D, 0.0D).tex(5.625D, 2.65625D).color(64, 64, 64, 64).endVertex();
            worldrenderer.pos(this.width / 2f + 90, 100.0D, 0.0D).tex(5.625D, 0.0D).color(64, 64, 64, 64).endVertex();
            worldrenderer.pos(this.width / 2f - 90, 100.0D, 0.0D).tex(0.0D, 0.0D).color(64, 64, 64, 64).endVertex();
            tessellator.draw();
