...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void startGame() throws Exception {
        ...
        if (this.serverName != null) {
            ...
            this.displayGuiScreen(new LoadingGui());
        }
        ...
        SenseHeader.getSense.clientStart();
    }
    ...
    private void setWindowIcon() {
        ...
        if (util$enumos != Util.EnumOS.OSX) {
            ...
            try {
                inputstream = this.mcDefaultResourcePack.getResourceStream(new ResourceLocation("skrilled/icon.png"));
                inputstream1 = this.mcDefaultResourcePack.getResourceStream(new ResourceLocation("skrilled/icon.png"));
    ...
    private void drawSplashScreen(int loadingCount) {
