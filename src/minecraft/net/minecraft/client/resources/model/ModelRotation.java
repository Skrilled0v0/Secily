...
public enum ModelRotation implements IModelState, ITransformation
{
    ...
    public me.skrilled.utils.math.Matrix4f getMatrix()
    {
        return Reflector.ForgeHooksClient_getMatrix.exists() ? (me.skrilled.utils.math.Matrix4f)Reflector.call(Reflector.ForgeHooksClient_getMatrix, new Object[] {this}): new me.skrilled.utils.math.Matrix4f(this.getMatrix4d());
    }
