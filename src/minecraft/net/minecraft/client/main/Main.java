...
import me.fontloader.FontLoader;
...
public class Main {
    ...
    public static void main(String[] p_main_0_) {
        ...
        OptionSpec<String> optionspec9 = optionparser.accepts("username").withRequiredArg().defaultsTo("Skrilled");
        ...
        OptionSpec<Integer> optionspec14 = optionparser.accepts("height").withRequiredArg().ofType(Integer.class).defaultsTo(680);
