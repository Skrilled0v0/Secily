...
public class WorldInfo {
    ...
    public void setWorldTime(long time) {
        if (SenseHeader.getSense.getModuleManager().getModuleByClass(WorldRenderEditor.class).isEnabled() && WorldRenderEditor.timeEditor.isOptionOpen())
            worldTime = (long) WorldRenderEditor.time.getDoubleCurrentValue();
        else
            this.worldTime = time;
    }
