...
import me.kl0udy92.apart.events.network.ConnectingEvent;
import me.kl0udy92.apart.utils.system.ServerUtil;
...
public class GuiConnecting extends GuiScreen
{
    ...
    private void connect(final String ip, final int port)
    {
        ...
        EventManager.INSTANCE.fire(new ConnectingEvent(ip, port));
        ...
        (new Thread("Server Connector #" + CONNECTION_ID.incrementAndGet())
        {
            public void run()
            {
                ...
                try
                {
                    ...
                    //Start play time.
                    ServerUtil.INSTANCE.setConnectedTime(System.currentTimeMillis());
                }
