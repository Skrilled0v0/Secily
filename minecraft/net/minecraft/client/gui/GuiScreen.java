...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    protected List<GuiSimpleButton> simpleButtonList = Lists.<GuiSimpleButton>newArrayList();
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.simpleButtonList.forEach(button -> button.drawSimpleButton(this.mc, mouseX, mouseY));
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        if (mouseButton == 0)
        {
            ...
            for (int i = 0; i < this.simpleButtonList.size(); ++i)
            {
                GuiSimpleButton guibutton = (GuiSimpleButton)this.simpleButtonList.get(i);
