...
import me.kl0udy92.apart.features.module.implementations.visual.BlockAnimationsModule;
            ...
            if (this.itemToRender != null)
            {
                ...
                else if (abstractclientplayer.getItemInUseCount() > 0)
                {
                    ...
                    switch (enumaction)
                    {
                        ...
                        case BLOCK:
                            if (Main.moduleManager.getModuleByClass(BlockAnimationsModule.class).getState()) {
                                switch (((BlockAnimationsModule) Main.moduleManager.getModuleByClass(BlockAnimationsModule.class)).getModeOption().getValue().toLowerCase()) {
                                    case "old":
                                    ...
                                    case "sigma":
                                        ...
                                        GlStateManager.rotate(-MathHelper.sin(f1 * f1 * 3.1415927F) * 55 / 2.0F, -8.0F, -0.0F, 9.0F);
                                        GlStateManager.rotate(-MathHelper.sin(f1 * f1 * 3.1415927F) * 45, 1.0F, MathHelper.sin(f1 * f1 * 3.1415927F) / 2, -0.0F);
                                        this.doBlockTransformations();
