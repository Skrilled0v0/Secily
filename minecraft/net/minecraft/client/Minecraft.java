...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    {
        EventManager.INSTANCE.fire(new MouseClickEvent(EventClickType.LEFT));
    ...
    {
        EventManager.INSTANCE.fire(new MouseClickEvent(EventClickType.RIGHT));
    ...
    public void runTick() throws IOException
    {
        ...
        EventManager.INSTANCE.fire(new TickEvent());
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                {
                    EventManager.INSTANCE.fire(new KeydownEvent(k));
                    KeyBinding.onTick(k);
                }
    ...
    {
        EventManager.INSTANCE.fire(new MouseClickEvent(EventClickType.MIDDLE));
        if (this.objectMouseOver != null)
        {
