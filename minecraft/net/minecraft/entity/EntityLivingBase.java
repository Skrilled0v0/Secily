...
import me.kl0udy92.apart.features.module.implementations.player.DelayModifierModule;
...
public abstract class EntityLivingBase extends Entity
{
    ...
    {
        EventManager.INSTANCE.fire(new LivingUpdateEvent(this));
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.isJumping)
        {
            ...
            {
                this.jump();
                if (Main.moduleManager.getModuleByClass(DelayModifierModule.class).getState() && ((DelayModifierModule) Main.moduleManager.getModuleByClass(DelayModifierModule.class)).getDelayFilterOption().find("Jump ticks").getValue()) {
                    this.jumpTicks = ((DelayModifierModule) Main.moduleManager.getModuleByClass(DelayModifierModule.class)).getJumpTicksDelay().getValue().intValue();
                }else this.jumpTicks = 10;
            }
        }
        else
        {
