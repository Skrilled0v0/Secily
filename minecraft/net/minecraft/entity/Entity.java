...
import me.kl0udy92.apart.features.module.implementations.attack.HitboxesModule;
...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            boolean flag = this.onGround && (this.isSneaking() || (
                    this == Minecraft.getMinecraft().thePlayer && Main.moduleManager.getModuleByName("SafeWalk").getState()
    ...
    {
        final HitboxesModule hitboxes = (HitboxesModule) Main.moduleManager.getModuleByClass(HitboxesModule.class);
        return (hitboxes.getState() && Math.random() >= hitboxes.getChanceOption().getValue() / 100) ? hitboxes.getSizeOption().getValue().floatValue() : 0.1F;
    }
